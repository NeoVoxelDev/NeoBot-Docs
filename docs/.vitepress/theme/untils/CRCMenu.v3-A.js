...
// Tip: 项目经过Neovoxel团队修改，新增了对多语言，黑暗模式，壁纸切换功能的支持
...
const createRightClickMenu = () => {
    ...
    const menuTranslations = {
        ...
        en: {
            ...
            fullscreenMode: 'Toggle Fullscreen',
    ...
    const getThemeColors = (theme) => {
        if (theme === 'dark') {
            ...
            return {
                ...
                '--text-color': 'rgba(60, 60, 60, 0.9)',
                '--header-color': 'rgba(100, 100, 100, 0.7)',
    ...
    const updateMenuTheme = (menuInstance) => {
        const currentTheme = getVitePressTheme();
        const colors = getThemeColors(currentTheme);

        const menuElement = menuInstance.shadowRoot?.querySelector('#custom-menu');
        if (menuElement) {
            Object.entries(colors).forEach(([key, value]) => {
                menuElement.style.setProperty(key, value);
            });
        }
    };

    const initialTheme = getVitePressTheme();
            ...
            groups: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            id: 'copy-image-link',
                            label: translations.copyImageUrl,
                            icon: 'fa-link',
                    ...
                    items: [
                        {
                            ...
                            children: [
                                {
                                    id: 'sub-1',
                                    label: translations.refreshWallpaper,
                                    icon: 'fa-image',
                                    callback: refreshWallpaperAction
                                },
                                {
                                    id: 'sub-2',
                                    label: translations.fullscreenMode,
    ...
    window.addEventListener('popstate', checkLanguageChange);
